...
See [DEPLOYMENT_GUIDE.md](DEPLOYMENT_GUIDE.md) for complete instructions on deploying to Vercel (frontend) and Render (backend).
...
**Built with:** NestJS, React, MongoDB, and Tailwind CSS
